...
<nav
	...
	<div class="container">
		<a class="navbar-brand" style="font-family:Times New Roman;font-style: oblique;font-size:30px;color:black;text-shadow: 2px 2px 6px white;" href="${contextRoot}/home">
		<b>Har!Har Technology</b></a>
